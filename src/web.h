...
String processor(const String& var)
{
	if (var == "CONFIGPLACEHOLDER")
	{
		...
		buttons += "<p class=\"CInput\"><label>SSID </label><input type = \"text\" name = \"jSSID\" value=\"";
		buttons += tWeb_Config.wAP_SSID;
		buttons += "\"/></p>";
		buttons += "<p class=\"CInput\"><label>Password </label><input type = \"text\" name = \"jPassword\" value=\"";
		buttons += tWeb_Config.wAP_Password;
		buttons += "\"/></p>";
		buttons += "<p class=\"CInput\"><label>Sensortyp </label><input type = \"text\" name = \"jBMP\" value=\"";
		buttons += tWeb_Config.wBMP_Sensortype;
		buttons += "\"/></p>";
		buttons += "<p class=\"CInput\"><label>Client IP </label><input type = \"text\" name = \"jClient_IP\" value=\"";
		buttons += tWeb_Config.wClient_IP;
		buttons += "\"/></p>";
		buttons += "<p class=\"CInput\"><label>Client Gateway </label><input type = \"text\" name = \"jClient_Gateway\" value=\"";
		buttons += tWeb_Config.wClient_Gateway;
		buttons += "\"/></p>";
		buttons += "<p class=\"CInput\"><label>Client Netmask </label><input type = \"text\" name = \"jClient_NMask\" value=\"";
		buttons += tWeb_Config.wClient_NMask;
		buttons += "\"/></p>";
		buttons += "<p class=\"CInput\"><label>Client DNS </label><input type = \"text\" name = \"jClient_DNS\" value=\"";
